...
namespace LoanManagementSolution
{
    partial class SystemLogIn
    {
        ...
        private void txtUsernameGotFocus(object sender, EventArgs e)
        {
            ...
            this.pbxIcon.Image = global::LoanManagementSolution.Properties.Resources.login_48x48;
        ...
        private void txtPasswordGotFocus(object sender, EventArgs e)
        {
            ...
            this.pbxIcon.Image = global::LoanManagementSolution.Properties.Resources.secrecy_48x48;
        ...
        private void txtPasswordKeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            { 
                this.pbxIcon.Image = global::LoanManagementSolution.Properties.Resources.loading2;
                ...
                _userInfo.NetworkInformation = BaseServices.ProcStatic.GetNetworkInformation();
                ...
                try
                {
                    ...
                    using (RemoteClient.RemCntAdministratorManager remClient = new RemoteClient.RemCntAdministratorManager())
                    {
                        ...
                        {
                            this.pbxIcon.Image = global::LoanManagementSolution.Properties.Resources.Symbol_Error;
                ...
                {
                    BaseServices.ProcStatic.ShowErrorDialog("There has been a problem in the attempt to access the system.\n\nPlease contact your system administrator.", "System Error");
                }
                finally
                {
