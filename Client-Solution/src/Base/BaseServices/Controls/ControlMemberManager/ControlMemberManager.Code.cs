...
namespace BaseServices.Controls
{
    ...
    public delegate void ControlMemberManagerResetQueryLinkClicked();
    public delegate void ControlMemberManagerRadioButtonCheckedChanged();
    ...
    partial class ControlMemberManager
    {
        ...
        public event ControlMemberManagerResetQueryLinkClicked OnResetLinkClicked;
        public event ControlMemberManagerRadioButtonCheckedChanged OnRadioButtonCheckedChanged;
        #endregion
        ...
        private void rdbActiveInActiveCheckedChanged(object sender, EventArgs e)
        {
            ...
            ControlMemberManagerRadioButtonCheckedChanged ev = OnRadioButtonCheckedChanged;
        ...
        private void lnkResetQueryLinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            this.chkIncludeMemberStatus.Checked = false;

            this.txtSearch.Clear();
            this.txtSearch.Focus();            

            ControlMemberManagerResetQueryLinkClicked ev = OnResetLinkClicked;
        ...
        {
            return this.gbxMemberStatus.Enabled ? true : false;
        }//--------------------------
        #endregion
    }
}
