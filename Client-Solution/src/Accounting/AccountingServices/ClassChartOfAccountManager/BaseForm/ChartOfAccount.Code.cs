...
namespace AccountingServices
{
    partial class ChartOfAccount
    {
        ...
        {
            _chartOfAccountInfo.CompanyPolicyProcedure = BaseServices.ProcStatic.TrimStartEndString(this.txtCompanyPolicy.Text);
        }//---------------------
        ...
        {
            _chartOfAccountInfo.AccountDescription = BaseServices.ProcStatic.TrimStartEndString(this.txtAccountDescription.Text);
        }//---------------------
        ...
        {
            _chartOfAccountInfo.AccountName = BaseServices.ProcStatic.TrimStartEndString(this.txtAccountName.Text);
        }//-------------------
        ...
        {
            _chartOfAccountInfo.AccountCode = BaseServices.ProcStatic.TrimStartEndString(this.txtAccountCode.Text);
        }//-------------------
