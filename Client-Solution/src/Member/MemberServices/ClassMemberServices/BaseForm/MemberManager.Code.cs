...
namespace MemberServices
{
    partial class MemberManager
    {
        ...
        public MemberManager(CommonExchange.SysAccess userInfo)
        {
            ...
            this.ctlManager.OnResetLinkClicked += new BaseServices.Controls.ControlMemberManagerResetQueryLinkClicked(ctlManagerOnResetLinkClicked);
            this.ctlManager.OnRadioButtonCheckedChanged += new BaseServices.Controls.ControlMemberManagerRadioButtonCheckedChanged(ctlManagerOnRadioButtonCheckedChanged);
        }
        #endregion
        ...
        //event is raised when the radio button checked is changed
        private void ctlManagerOnRadioButtonCheckedChanged()
        {
            this.ShowSearchResultDialog(true);
        }//-------------------------
        ...
        {
            if (!RemoteServerLib.ProcStatic.IsSystemAccessAdmin(_userInfo) && !RemoteServerLib.ProcStatic.IsSystemAccessDataController(_userInfo))
            {
                _frmMemberSearch.DisableCreateLink();
            }
        }//--------------------------------
        #endregion
    }
