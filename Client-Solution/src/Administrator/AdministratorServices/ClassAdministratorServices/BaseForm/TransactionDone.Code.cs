...
namespace AdministratorServices
{
    partial class TransactionDone
    {
        ...
        private AdministrationLogic _administrationManager;
        private CommonExchange.TransactionLog _transactionLogInfo;
        DataTable _transactionDoneTable;
        #endregion

        #region Class Constructors
        public TransactionDone(CommonExchange.SysAccess userInfo, AdministrationLogic adminitrationManager, CommonExchange.TransactionLog transactionLogInfo)
        {
        ...
        private void ClassLoad(object sender, EventArgs e)
        {
            ...
            this.lblCompleteName.Text = BaseServices.ProcStatic.GetCompleteNameMiddleInitial(_transactionLogInfo.UserInfo.PersonInfo.LastName,
        ...
        private void btnPrintClick(object sender, EventArgs e)
        {
            try
            {
                    ...
                    new AdministratorServices.ClassAdministratorServices.CrystalReport.CrystalTransaction())
                {
                    ...
                    rptTransaction.SetParameterValue("@complete_name",
                        BaseServices.ProcStatic.GetCompleteNameMiddleInitial(_transactionLogInfo.UserInfo.PersonInfo.LastName,
                    ...
                    rptTransaction.SetParameterValue("@print_Info", "Date/Time Printed: " +
                        ...
                        BaseServices.ProcStatic.GetCompleteNameMiddleInitial(_userInfo.PersonInfo.LastName, _userInfo.PersonInfo.FirstName,
                        _userInfo.PersonInfo.MiddleName));

                    using (BaseServices.CrystalReportViewer frmViewer = new BaseServices.CrystalReportViewer(rptTransaction))
                    {
            ...
            {
                BaseServices.ProcStatic.ShowErrorDialog(ex.Message, "Error Printing");
            }
        }//------------------------
        //###########################################END BUTTON btnClose EVENTS#####################################################
        #endregion 
