...
{
    public class AdministrationLogic : BaseServices.BaseServicesLogic
    {
        ...
        public AdministrationLogic(CommonExchange.SysAccess userInfo)
            : base(userInfo)
        {
                ...
                if (_personDocumentTable != null)
                {
                    ...
                    foreach (DataRow docRow in _personDocumentTable.Rows)
                    {
                            ...
                            String.IsNullOrEmpty(RemoteServerLib.ProcStatic.DataRowConvert(docRow, "sysid_person", String.Empty)))
                        {
                            ...
                            editRow["sysid_person"] = newUserInfo.PersonInfo.PersonSysId;
                ...
                if (_personDocumentTable != null)
                {
                    ...
                    foreach (DataRow docRow in _personDocumentTable.Rows)
                    {
                        if (docRow.RowState != DataRowState.Deleted &&
                            String.IsNullOrEmpty(RemoteServerLib.ProcStatic.DataRowConvert(docRow, "sysid_person", String.Empty)))
                        {
                            DataRow editRow = _personDocumentTable.Rows[count];

                            editRow.BeginEdit();

                            editRow["sysid_person"] = editUserInfo.PersonInfo.PersonSysId;
        ...
        public void InitializeAccessRightsDataGridView(DataGridView dgvBase)
        {
            if (_classDataSet != null)
            {
                foreach (DataRow accessRow in _classDataSet.Tables["SystemAccessRightsTable"].Rows)
                {
                    ...
                    DataGridViewCell[] dgvCell = new DataGridViewCell[] {chkCell, txtAccessDescriptionCell };
        ...
        public void InitializeUserCombo(ComboBox cboBase)
        {
            ...
            foreach (DataRow userRow in _userInformationTable.Rows)
            {
                cboBase.Items.Add(BaseServices.ProcStatic.GetCompleteNameMiddleInitial(userRow, "last_name", "first_name", "middle_name") + " - [" +
        ...
        public DataTable GetSearchUserInformation(CommonExchange.SysAccess userInfo, String queryString)
        {
            ...
            foreach (DataRow userRow in _userInformationTable.Rows)
            {
                ...
                newRow["user_name"] = BaseServices.ProcStatic.GetCompleteNameMiddleInitial(userRow, "last_name", "first_name", "middle_name");
        ...
        public DataTable GetSearchTransactionLog(CommonExchange.SysAccess userInfo, String queryString, String userId, String dateStart, String dateEnd)
        {
            ...
            foreach (DataRow logRow in _transactionLogTable.Rows)
            {
                ...
                newRow["user_name"] = BaseServices.ProcStatic.GetCompleteNameMiddleInitial(logRow, "last_name", "first_name", "middle_name");
