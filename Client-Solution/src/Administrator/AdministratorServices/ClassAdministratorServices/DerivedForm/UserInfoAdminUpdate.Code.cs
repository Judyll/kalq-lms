...
namespace AdministratorServices
{
    partial class UserInfoAdminUpdate
    {
        ...
        public UserInfoAdminUpdate(CommonExchange.SysAccess userInfo, AdministrationLogic administarationManager, CommonExchange.SysAccess newUserInfo)
        ...
        private void btnUpdateClick(object sender, EventArgs e)
        {
            ...
            if (this.BaseValidateControls() && this.ValidateControlsUser() && !_hasErrors)
            {
                try
                {
        ...
        private void UpdateUserAccessRights()
        {
            ...
            foreach (DataGridViewRow dgvRow in this.dgvList.Rows)
            {
                ...
                if ((Boolean)dgvRow.Cells["checkbox_column"].Value)
                {
