...
{
    partial class ShareCapitalMultiplePayment
    {
        ...
        public ShareCapitalMultiplePayment(CommonExchange.SysAccess userInfo, CashieringLogic cashieringManager)
        {
        ...
        //###########################################CLASS ShareCapitalMultiplePayment EVENTS#####################################################
        ...
        //###########################################END CLASS ShareCapitalMultiplePayment EVENTS#####################################################
        ...
        private void btnRecordClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    String strMsg = "Are you sure you want to record the new share capital credit multiple payment?";
                    ...
                    {
                        strMsg = "The share capital credit multiple payment has been successfully recorded.";

                        this.Cursor = Cursors.WaitCursor;

                        _cashieringManager.InsertUpdateDeleteShareCapitalCreditPayments(_userInfo, (DataTable)this.dgvPaymentList.DataSource);
            ...
            {
                BaseServices.ProcStatic.ShowErrorDialog("Error inserting share capital credit multiple payment.\n\n" + ex.Message, "Error Inserting");
            }
        }//--------------------------
