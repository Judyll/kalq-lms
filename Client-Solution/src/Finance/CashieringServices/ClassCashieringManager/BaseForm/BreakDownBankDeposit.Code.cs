            ...
            try
            {
                ...
                using (BaseServices.ChartOfAccountSearchOnTextBoxList frmSearch = new BaseServices.ChartOfAccountSearchOnTextBoxList(_userInfo, _cashieringManager))
                {
                    ...
                    if (frmSearch.HasSelected)
                    {
                        ...
                        //    _cashieringManager.GetDetailsChartOfAccount(_userInfo, frmSearch.PrimaryId);

                        _breakDownDepositInfo.AccountInfo = _cashieringManager.GetDetailsChartOfAccount(_userInfo, frmSearch.PrimaryId);
