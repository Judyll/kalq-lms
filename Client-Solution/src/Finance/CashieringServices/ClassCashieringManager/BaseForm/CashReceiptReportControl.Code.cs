...
namespace CashieringServices
{
    partial class CashReceiptReportControl
    {
        ...
        private void SearchForCashReciptDetails(String dateStart, String dateEnd)
        {
            ...
            _cashieringManager.SelectByDateStartEndCashReceiptsDetailedPaymentsCreditsMiscellaneousIncome(_userInfo, dateStart, dateEnd, 
        ...
        private void SearchForCashReciptSummarized(String dateStart, String dateEnd)
        {
            ...
            _cashieringManager.SelectByDateStartEndCashReceiptsSummarizedPaymentsCreditsMiscellaneousIncome(_userInfo, dateStart, dateEnd,
                this.chkIsConsolidated.Checked);
