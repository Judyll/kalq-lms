        ...
        private void btnUpdateClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msgResult == DialogResult.Yes)
                {
                    ...
                    _breakDownDepositInfo.ObjectState = DataRowState.Modified;
        ...
        private void btnDeleteClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (msgResult == DialogResult.Yes)
                {
                    ...
                    _breakDownDepositInfo.ObjectState = DataRowState.Deleted;
            ...
            {
                BaseServices.ProcStatic.ShowErrorDialog(ex.Message, "Error in Deleting");
            }
        }//---------------------------
