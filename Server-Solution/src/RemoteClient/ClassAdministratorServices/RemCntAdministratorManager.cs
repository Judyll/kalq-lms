...
namespace RemoteClient
{
    public class RemCntAdministratorManager : IDisposable
    {
        ...
        {
            RemoteServerLib.RemSrvAdministratorManager remServer =
                (RemoteServerLib.RemSrvAdministratorManager)Activator.GetObject(typeof(RemoteServerLib.RemSrvAdministratorManager),
