    ...
    public partial class ProcStatic
    {
        ...
        public static DataTable GetCodeReferenceTable(SqlConnection sqlConn, String userId)
        {
            ...
            using (SqlCommand sqlComm = new SqlCommand())
            {
                ...
                sqlComm.CommandText = "lms.SelectCodeReference";
        ...
        public static DataTable GetRelationshipTypeTable(SqlConnection sqlConn, String userId)
        {
            ...
            using (SqlCommand sqlComm = new SqlCommand())
            {
                sqlComm.Connection = sqlConn;
                sqlComm.CommandType = CommandType.StoredProcedure;
                sqlComm.CommandText = "lms.SelectRelationshipType";
        ...
        //this function determines if the access code is an admin
        ...
        //this function determines if the access code is a loan officer
        public static Boolean IsSystemAccessLoanOfficer(CommonExchange.SysAccess userInfo)
        {
            foreach (CommonExchange.AccessRightsGranted access in userInfo.AccessRightsGrantedList)
            {
        ...
        //this function determines if the access code is an disbursement officer
        public static Boolean IsSystemAccessDisbursementOfficer(CommonExchange.SysAccess userInfo)
        {
            foreach (CommonExchange.AccessRightsGranted access in userInfo.AccessRightsGrantedList)
            {
        ...
        //this function determines if the access code is an bookkeeper
        ...
        //this function determines if the access code is a data controller
        public static Boolean IsSystemAccessDataController(CommonExchange.SysAccess userInfo)
        {
            foreach (CommonExchange.AccessRightsGranted access in userInfo.AccessRightsGrantedList)
            {
