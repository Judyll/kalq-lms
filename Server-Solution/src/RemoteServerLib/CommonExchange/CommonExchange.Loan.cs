...
namespace CommonExchange
{
    ...
    public class RegularLoanCharges : BaseObject
    {
        public RegularLoanCharges()
        {
            ...
            _regularLoanSysIdForwarded = String.Empty;
        }
        ...
        private String _regularLoanSysIdForwarded;
        public String RegularLoanSysIdForwarded
        {
            get { return _regularLoanSysIdForwarded; }
            set { _regularLoanSysIdForwarded = value; }
        }
